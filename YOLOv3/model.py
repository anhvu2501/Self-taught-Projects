# Create a yolov3 model using pretrained weights
# Based on a blog of Jason Brownlee on machinelearningmastery.com

# By now still using pretrained weights for this model as the final model to detect and recognize object
# Test accuracy is not good yet
# Note: Still looking for good dataset (enough to train)
...
weight_reader = WeightReader('../Pretrained Models/yolov3.weights')
# set the model weights into the model
weight_reader.load_weights(model)

# Model Summary and set model ready to be trained
# print(model.summary())
# model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])

# Take dataset and preprocess it


# Convert y_train, y_test to one-hot presentation
